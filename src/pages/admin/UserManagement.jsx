  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-[#162F5C] dark:text-white tracking-tight">Manajemen Pengguna</h1>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl p-5 border border-slate-200/80 dark:border-gray-800 shadow-xs flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex items-center space-x-2 border-b md:border-b-0 border-gray-200 dark:border-gray-700 pb-2 md:pb-0 overflow-x-auto">
          <button
            onClick={() => setActiveTab('all')}
            className={`px-4 py-2 rounded-full text-xs font-semibold whitespace-nowrap transition-all ${
              activeTab === 'all'
                ? 'bg-[#162F5C] text-white shadow-xs rounded-full'
                : 'text-gray-600 dark:text-gray-300 dark:hover:bg-gray-800 hover:bg-gray-100'
            }`}
          >
        ...
        <div className="relative w-full md:w-72">
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-xs border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-slate-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-1 focus:ring-[#1E4B8E] focus:outline-none"
          />
          ...
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="border-b border-slate-100 dark:border-gray-800 text-slate-400 dark:text-gray-500 font-bold uppercase tracking-wider text-[10px]">
                ...
                <th className="py-3.5 px-5">No. HP</th>
                <th className="py-3.5 px-5">Peran / Role</th>
                <th className="py-3.5 px-5">Status Akun</th>
                <th className="py-3.5 px-5">Tanggal Terdaftar</th>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-gray-800">
              {loading ? (
                ...
                filteredUsers.map((u) => (
                  <tr key={u.id} className="hover:bg-slate-50/80 dark:hover:bg-gray-800/50 transition-colors">
                    ...
                    <td className="py-3.5 px-5">
                      ...
                      {u.status === 'inactive' && (
                        <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-gray-100 text-gray-600 dark:text-gray-300">
                          Nonaktif
                        </span>
                      )}
                    </td>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-md w-full p-5 text-xs">
            ...
            <form onSubmit={handleAddUser} className="space-y-3">
              <div>
                <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Nama Lengkap</label>
                <input
                  type="text"
                  value={addForm.name}
                  ...
                  required
                  className="w-full px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-slate-800 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:ring-1 focus:ring-[#1E4B8E] focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Username Login</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Password Awal</label>
                <input
                  type="password"
              ...
              <div>
                <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">No. HP (WhatsApp)</label>
                <input
                  type="text"
                  value={addForm.phone}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Peran / Role</label>
                  <select
                    value={addForm.role}
                ...
                <div>
                  <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Status Akun</label>
                  <select
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-md w-full p-5 text-xs">
            ...
            <form onSubmit={handleEditUser} className="space-y-3">
              ...
              <div>
                <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">No. HP</label>
                <input
                  type="text"
      ...
      {showResetModal && selectedUser && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-sm w-full p-5 text-xs">
            <h3 className="font-bold text-sm text-[#1A1A2E] dark:text-white mb-2">
              Reset Password User
            </h3>
