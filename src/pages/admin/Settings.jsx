...
const Settings = () => {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        <h1 className="text-3xl font-extrabold text-[#162F5C] dark:text-white tracking-tight">Pengaturan Akun Admin</h1>
      ...
      {/* Profil Form */}
      <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-slate-200/80 dark:border-gray-800 shadow-xs">
        ...
        <form onSubmit={handleUpdateProfile} className="space-y-4 text-xs">
          ...
          <div>
            <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Nomor Handphone / WhatsApp</label>
            <input
              type="text"
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-slate-200/80 dark:border-gray-800 shadow-xs">
        ...
        <form onSubmit={handleChangePassword} className="space-y-4 text-xs">
          <div>
            <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Password Saat Ini</label>
            <input
              type="password"
          ...
          <div>
            <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Password Baru</label>
            <input
              type="password"
          ...
          <div>
            <label className="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Konfirmasi Password Baru</label>
            <input
              type="password"
